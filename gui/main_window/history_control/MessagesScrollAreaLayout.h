...
namespace Ui
{
    ...
    private:
        ...
        int getPossibleOffset(QRect itemRect, qint64 countAfter, int delta) const;
        ...
        bool isVisibleEnoughForRead(const QRect& _widgetAbsGeometry, const QRect& _viewportVisibilityAbsRect) const;
